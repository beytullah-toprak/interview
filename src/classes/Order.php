...
/**
 * Sipariş uçlarını (/order-token, /order) yöneten sınıf.
 *
 * Home ile aynı desende: route tanımı Main.php'de kalır, işin kendisi
 * burada. Böylece Main.php yalnızca "hangi URL hangi sınıfa gider"
